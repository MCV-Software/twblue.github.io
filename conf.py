...
BLOG_AUTHOR = "MCV Software"  # (translatable)
...
BLOG_EMAIL = "manuel@manuelcortez.net"
BLOG_DESCRIPTION = "The TWBlue official website"  # (translatable)
...
#        ("/es/faq", "Preguntas frecuentes"),
    ...
    "ru": (
        ("/index.html", "Главное"),
        ("/ru/donate", "внести пожертвование"),
...
LOCALES = {"en": "en_US.UTF-8", "es": "es_ES.UTF-8", "ru": "ru_RU.UTF-8", "fr": "fr_FR.UTF-8"}
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="https://mcvsoftware.com">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
